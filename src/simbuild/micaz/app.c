...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b9344511cf8, const void *arg_0x2b9344510020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b9344592618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b93447d38e8), 
int (*key_eq_fn)(void *arg_0x2b93447d20c8, void *arg_0x2b93447d2368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b93449e3610, int arg_0x2b93449e3878);
static double RandomUniform(void );
...
} __attribute__((packed)) nx_NeighbourUnit;
...
typedef TMilli ORWNeighbourTestC$Timer1$precision_tag;
...
static void ORWNeighbourTestC$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ORWNeighbourTestC$Timer1$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
collection_id_t arg_0x2b93454220c8, 
...
collection_id_t arg_0x2b9345423518, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
collection_id_t arg_0x2b9345424958, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
error_t error);
# 46 "/opt/tinyos-2.1.2/tos/lib/net/CollectionId.nc"
static collection_id_t /*ORWNeighbourTestAppC.CollectionSenderC.CollectionSenderP.CollectionIdP*/CollectionIdP$0$CollectionId$fetch(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t ORWNeighbourTestC$Send$send(
#line 67
message_t * msg, 
...
ORWNeighbourTestC$Send$getPayload(
#line 122
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ORWNeighbourTestC$Timer1$startPeriodic(uint32_t dt);
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
static error_t ORWNeighbourTestC$RoutingControl$start(void );
# 45 "ORWNeighbourTestC.nc"
NeighbourUnit ORWNeighbourTestC$neighbourSet[1000][10 * MAX_NEIGHBOUR_NUM];
nx_NeighbourUnit ORWNeighbourTestC$nx_neighbourSet[1000][MAX_NEIGHBOUR_NUM];
message_t ORWNeighbourTestC$pkt[1000];
#line 47
message_t ORWNeighbourTestC$packet[1000];
...
#line 182
static inline void ORWNeighbourTestC$convertNX(void );
...
static inline void ORWNeighbourTestC$sendMessage(void );
...
static inline void ORWNeighbourTestC$Send$sendDone(message_t *msg, error_t error);




static message_t *ORWNeighbourTestC$CTPReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 256
static inline void ORWNeighbourTestC$Timer1$fired(void );
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
static uint8_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableFind(am_addr_t arg_0x2b93457b5678);
static inline error_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableUpdateEntry(am_addr_t arg_0x2b93457b4020, am_addr_t arg_0x2b93457b42e8, uint16_t arg_0x2b93457b45a8);
...
static inline collection_id_t /*ORWNeighbourTestAppC.CollectionSenderC.CollectionSenderP.CollectionIdP*/CollectionIdP$0$CollectionId$fetch(void );
...
#line 108
      ...
      __nesc_hton_uint8(btrpkt1->dstid.nxdata, (signed char )sourceid);
      __nesc_hton_uint8(btrpkt1->sourceid.nxdata, (signed char )TOS_NODE_ID);
...
#line 205
      if (__nesc_ntoh_uint8(btrpkt->dstid.nxdata) == 0xFF) {
          ORWNeighbourTestC$ackMsgSend(__nesc_ntoh_uint8(btrpkt->sourceid.nxdata));
        }
      else {
#line 208
        if (__nesc_ntoh_uint8(btrpkt->dstid.nxdata) - TOS_NODE_ID == 0) {
            sim_log_debug(160U, "AMInfo", "received ACK from %d, estimating\n", __nesc_ntoh_uint8(btrpkt->sourceid.nxdata));
            ORWNeighbourTestC$addSet(__nesc_ntoh_uint8(btrpkt->sourceid.nxdata));
            ORWNeighbourTestC$estLinkQuality(__nesc_ntoh_uint8(btrpkt->sourceid.nxdata));
            sim_log_debug(161U, "Neighbour", "\nHAS NEIGHBOURS:");
...
#line 578
{
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$MessagePool$empty()) {
      sim_log_debug(224U, "Route", "%s cannot forward, message pool empty.\n", __FUNCTION__);
...
#line 584
    if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$QEntryPool$empty()) {
        sim_log_debug(225U, "Route", "%s cannot forward, queue entry pool empty.\n", __FUNCTION__);
        ...
        if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$enqueue(qe) == SUCCESS) {
            sim_log_debug(226U, "Forwarder,Route", "%s forwarding packet %p with queue size %hhu\n", __FUNCTION__, m, /*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$size());
...
# 31 "/opt/tinyos-2.1.2/tos/interfaces/Intercept.nc"
inline static bool /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$forward(collection_id_t arg_0x2b93454220c8, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$default$forward(arg_0x2b93454220c8, msg, payload, len);
#line 31
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$receive(collection_id_t arg_0x2b9345424958, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b9345424958) {
#line 78
    case 0xe1:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$default$receive(arg_0x2b9345424958, msg, payload, len);
#line 78
      break;
#line 78
    }
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$maxPayloadLength(am_id_t arg_0x2b934531e488){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = TossimActiveMessageC$AMSend$maxPayloadLength(arg_0x2b934531e488);
#line 123
...
#line 715
  ...
  if (idx == 10) {
      ...
      sim_log_debug(303U, "TreeRouting", "%s FAIL, table full\n", __FUNCTION__);
      return FAIL;
    }
  else {
#line 726
    if (idx == /*CtpP.Router*/CtpRoutingEngineP$0$routingTableActive[sim_node()]) {
        ...
        if (/*CtpP.Router*/CtpRoutingEngineP$0$passLinkEtxThreshold(linkEtx)) {
            ...
            sim_log_debug(304U, "TreeRouting", "%s OK, new entry\n", __FUNCTION__);
          }
        else 
#line 736
          {
            sim_log_debug(305U, "TreeRouting", "%s Fail, link quality (%hu) below threshold\n", __FUNCTION__, linkEtx);
          }
      }
    else 
#line 739
      {
        ...
        /*CtpP.Router*/CtpRoutingEngineP$0$routingTable[sim_node()][idx].info.etx = etx;
        /*CtpP.Router*/CtpRoutingEngineP$0$routingTable[sim_node()][idx].info.haveHeard = 1;
        sim_log_debug(306U, "TreeRouting", "%s OK, updated entry\n", __FUNCTION__);
      }
    }
#line 747
  return SUCCESS;
...
#line 502
{
  ...
  if (nidx != LinkEstimatorP$INVALID_RVAL) {
      sim_log_debug(268U, "LI", "insert: Found the entry, no need to insert\n");
      return SUCCESS;
    }

  nidx = LinkEstimatorP$findEmptyNeighborIdx();
  if (nidx != LinkEstimatorP$INVALID_RVAL) {
      sim_log_debug(269U, "LI", "insert: inserted into the empty slot\n");
...
#line 516
    {
      ...
      if (nidx != LinkEstimatorP$INVALID_RVAL) {
          sim_log_debug(270U, "LI", "insert: inserted by replacing an entry for neighbor: %d\n", LinkEstimatorP$NeighborTable[sim_node()][nidx].ll_addr);
...
#line 467
{
  ...
  if (len != sizeof(ctp_routing_header_t )) {
      sim_log_debug(297U, "LITest", "%s, received beacon of size %hhu, expected %i\n", __FUNCTION__, len, (int )sizeof(ctp_routing_header_t ));
  ...
  if (__nesc_ntoh_uint16(rcvBeacon->parent.nxdata) != INVALID_ADDR) {
      ...
      if (__nesc_ntoh_uint16(rcvBeacon->etx.nxdata) == 0) {
          sim_log_debug(299U, "TreeRouting", "from a root, inserting if not in table\n");
...
#line 631
{
  ...
  sim_log_debug(273U, "LI", "LI receiving packet, buf addr: %x\n", payload);
  ...
  if (LinkEstimatorP$SubAMPacket$destination(msg) == AM_BROADCAST_ADDR) {
      ...
      sim_log_debug(274U, "LI", "Got seq: %d from link: %d\n", __nesc_ntoh_uint8(hdr->seq.nxdata), ll_addr);
...
#line 664
      ...
      if (nidx != LinkEstimatorP$INVALID_RVAL) {
          sim_log_debug(275U, "LI", "Found the entry so updating\n");
...
#line 668
        {
          nidx = LinkEstimatorP$findEmptyNeighborIdx();
          if (nidx != LinkEstimatorP$INVALID_RVAL) {
              sim_log_debug(276U, "LI", "Found an empty entry\n");
...
#line 681
                {
                  sim_log_debug(278U, "LI", "No room in the table\n");
                }
            }
        }
#line 701
...
#line 705
          sim_log_debug(279U, "LI", "Number of footer entries: %d\n", num_entries);
...
#line 735
{
  sim_log_debug(281U, "LI", "Received upper packet. Will signal up\n");
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b9344dfa340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b9344dfa340) {
#line 78
    case 5:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b9344dfa340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 340
                {
                  sim_log_debug(257U, "LI", "Making link: %d mature\n", i);
                  ne->flags |= MATURE_ENTRY;
                  totalPkt = ne->rcvcnt + ne->failcnt;
                  sim_log_debug(258U, "LI", "MinPkt: %d, totalPkt: %d\n", minPkt, totalPkt);
                  if (totalPkt < minPkt) {
                      totalPkt = minPkt;
                    }
                  if (totalPkt == 0) {
...
#line 350
                    {
                      ...
                      sim_log_debug(259U, "LI,LITest", "  %hu: %hhu -> %hhu", ne->ll_addr, ne->inquality, (LinkEstimatorP$ALPHA * ne->inquality + (10 - LinkEstimatorP$ALPHA) * newEst + 5) / 10);
              ...
              sim_log_debug(260U, "LI", " - entry %i is invalid.\n", (int )i);
            }
        }
    }
}
...
#line 78
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b934531e488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b934531e488, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b9344dfb220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b9344dfb220, msg, error);
#line 110
}
#line 110
...
#line 83
# 238 "ORWNeighbourTestC.nc"
static inline void ORWNeighbourTestC$Send$sendDone(message_t *msg, error_t error)
#line 238
{
  ORWNeighbourTestC$busy[sim_node()] = FALSE;
  sim_log_debug(164U, "CTPInfo", "CTP Send done.\n");
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$sendDone(uint8_t arg_0x2b9345425790, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b9345425790) {
#line 100
    case 0U:
#line 100
      ORWNeighbourTestC$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$default$sendDone(arg_0x2b9345425790, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$receive(collection_id_t arg_0x2b9345423518, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$default$receive(arg_0x2b9345423518, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b9344df9020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b9344df9020) {
#line 78
    case 113:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b9344df9020, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 262
{
  sim_log_debug(204U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
  /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
}
...
#line 610
  sim_log_debug(301U, "TreeRouting", "%s I'm a root now!\n", __FUNCTION__);
...
#line 439
{
  sim_log_debug(266U, "LI", "Link estimator start\n");
  return SUCCESS;
}
...
#line 256
{
  ...
  sim_log_debug(286U, "TreeRoutingCtl", "%s running: %d radioOn: %d\n", __FUNCTION__, /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()], /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()]);
}
...
# 145 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$sendDoneTask$runTask(void )
#line 145
{
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b934531f318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b934531f318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b934531f318, msg, error);
#line 100
      break;
#line 100
    }
...
#line 373
  sim_log_debug(210U, "Forwarder", "%s: Trying to send a packet. Queue size is %hhu.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$size());
...
#line 378
    ...
    /*CtpP.Forwarder*/CtpForwardingEngineP$0$CtpInfo$getEtx(&gradient) != SUCCESS) {
        ...
        sim_log_debug(211U, "Forwarder", "%s: no route, don't send, try again in %i.\n", __FUNCTION__, NO_ROUTE_RETRY);
...
#line 412
        ...
        sim_log_debug(212U, "Forwarder", "Sending queue entry %p\n", qe);
        ...
        if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$RootControl$isRoot()) {
            ...
            sim_log_debug(213U, "Forwarder", "%s: I'm a root, so loopback and signal receive.\n", __FUNCTION__);
            ...
            if (subsendResult == SUCCESS) {
                ...
                sim_log_debug(214U, "Forwarder", "%s: subsend succeeded with %p.\n", __FUNCTION__, qe->msg);
                return;
              }
            else {
              if (subsendResult == ESIZE) {
                  sim_log_debug(215U, "Forwarder", "%s: subsend failed from ESIZE: truncate packet.\n", __FUNCTION__);
                  ...
                  sim_log_debug(216U, "Forwarder", "%s: subsend failed from %i\n", __FUNCTION__, (int )subsendResult);
                }
              }
          }
      }
...
#line 125
  sim_log_debug(249U, "LI", "newlen1 = %d\n", len);
  ...
  sim_log_debug(250U, "LI", "Max payload is: %d, maxEntries is: %d\n", LinkEstimatorP$SubPacket$maxPayloadLength(), maxEntries);
...
#line 147
  ...
  sim_log_debug(252U, "LI", "newlen2 = %d\n", newlen);
  return newlen;
}
...
#line 602
  ...
  sim_log_debug(271U, "LITest", "%s packet of length %hhu became %hhu\n", __FUNCTION__, len, newlen);
  sim_log_debug(272U, "LI", "Sending seq: %d\n", LinkEstimatorP$linkEstSeq[sim_node()]);
...
#line 425
    if (eval == EOFF) {
        /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()] = FALSE;
        sim_log_debug(295U, "TreeRoutingCtl", "%s running: %d radioOn: %d\n", __FUNCTION__, /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()], /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()]);
      }
    }
}
...
#line 277
  ...
  sim_log_debug(287U, "TreeRouting", "%s\n", __FUNCTION__);
  ...
  for (i = 0; i < /*CtpP.Router*/CtpRoutingEngineP$0$routingTableActive[sim_node()]; i++) {
      ...
      if (entry->info.parent == INVALID_ADDR || entry->info.parent == /*CtpP.Router*/CtpRoutingEngineP$0$my_ll_addr[sim_node()]) {
          sim_log_debug(288U, "TreeRouting", "routingTable[%d]: neighbor: [id: %d parent: %d  etx: NO ROUTE]\n", i, entry->neighbor, entry->info.parent);
      ...
      if (!/*CtpP.Router*/CtpRoutingEngineP$0$passLinkEtxThreshold(linkEtx)) {
          sim_log_debug(291U, "TreeRouting", "   did not pass threshold.\n");
          continue;
        }

      if (pathEtx < minEtx) {
          sim_log_debug(292U, "TreeRouting", "   best is %d, setting to %d\n", pathEtx, entry->neighbor);
          minEtx = pathEtx;
          best = entry;
        }
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b9344ae4020){
#line 75
  switch (arg_0x2b9344ae4020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b9344ae4020);
#line 75
      break;
#line 75
    }
...
#line 75
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ORWNeighbourTestC$Timer1$startPeriodic(uint32_t dt){
#line 64
...
#line 74
      ...
      __nesc_hton_uint8(btrpkt->dstid.nxdata, 0xFF);
      __nesc_hton_uint8(btrpkt->sourceid.nxdata, (signed char )TOS_NODE_ID);
      if (ORWNeighbourTestC$AMSend$send(AM_BROADCAST_ADDR, &ORWNeighbourTestC$pkt[sim_node()], sizeof(NeighbourMsg )) == SUCCESS) {
          ORWNeighbourTestC$busy[sim_node()] = TRUE;
...
#line 93
      {
        ...
        ORWNeighbourTestC$Timer1$startPeriodic(NEIGHBOUR_PERIOD_MILLI);
      }
    }
}
...
# 46 "/opt/tinyos-2.1.2/tos/lib/net/CollectionId.nc"
inline static collection_id_t /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionId$fetch(uint8_t arg_0x2b934543acb8){
#line 46
  unsigned char __nesc_result;
#line 46

#line 46
  switch (arg_0x2b934543acb8) {
#line 46
    case 0U:
#line 46
      __nesc_result = /*ORWNeighbourTestAppC.CollectionSenderC.CollectionSenderP.CollectionIdP*/CollectionIdP$0$CollectionId$fetch();
#line 46
      break;
#line 46
    default:
#line 46
      __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionId$default$fetch(arg_0x2b934543acb8);
#line 46
      break;
#line 46
    }
...
#line 46
# 345 "/opt/tinyos-2.1.2/tos/lib/net/ctp/CtpForwardingEngineP.nc"
static inline uint8_t /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$maxPayloadLength(uint8_t client)
#line 345
{
...
#line 297
  sim_log_debug(205U, "Forwarder", "%s: sending packet from client %hhu: %x, len %hhu\n", __FUNCTION__, client, msg, len);
...
#line 299
  ...
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$clientPtrs[sim_node()][client] == (void *)0) {
      sim_log_debug(206U, "Forwarder", "%s: send failed as client is busy.\n", __FUNCTION__);
      return EBUSY;
    }
  ...
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$enqueue(qe) == SUCCESS) {
      ...
      sim_log_debug(209U, "Forwarder", "%s: send failed as packet could not be enqueued.\n", __FUNCTION__);
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t ORWNeighbourTestC$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 184
  for (i = 0; i < (MAX_NEIGHBOUR_NUM < ORWNeighbourTestC$neighbourNumIndex[sim_node()] ? MAX_NEIGHBOUR_NUM : ORWNeighbourTestC$neighbourNumIndex[sim_node()]); i++) {
      __nesc_hton_uint8(ORWNeighbourTestC$nx_neighbourSet[sim_node()][i].nodeid.nxdata, (unsigned char )ORWNeighbourTestC$neighbourSet[sim_node()][i].nodeid);
      __nesc_hton_uint8(ORWNeighbourTestC$nx_neighbourSet[sim_node()][i].linkquality.nxdata, (unsigned char )(ORWNeighbourTestC$neighbourSet[sim_node()][i].linkquality * 100));
    }
}
...
inline static void * ORWNeighbourTestC$Send$getPayload(message_t * msg, uint8_t len){
#line 125
  void *__nesc_result;
#line 125
...
#line 125
# 190 "ORWNeighbourTestC.nc"
static inline void ORWNeighbourTestC$sendMessage(void )
#line 190
{
  CTPMsg *ctpmsg = (CTPMsg *)ORWNeighbourTestC$Send$getPayload(&ORWNeighbourTestC$packet[sim_node()], sizeof(CTPMsg ));

#line 192
  ORWNeighbourTestC$convertNX();
  __nesc_hton_int8(ctpmsg->neighbourNum.nxdata, ORWNeighbourTestC$neighbourNumIndex[sim_node()]);
  __nesc_hton_int8(ctpmsg->nodeid.nxdata, (unsigned char )TOS_NODE_ID);
  __nesc_hton_int16(ctpmsg->power.nxdata, 1000);
  memcpy(ctpmsg->neighbourSet, ORWNeighbourTestC$nx_neighbourSet[sim_node()], sizeof ORWNeighbourTestC$nx_neighbourSet[sim_node()]);
  ORWNeighbourTestC$Send$send(&ORWNeighbourTestC$packet[sim_node()], sizeof(CTPMsg ));
  ORWNeighbourTestC$busy[sim_node()] = TRUE;
}
...
#line 256
{
  if (!ORWNeighbourTestC$busy[sim_node()] && TOS_NODE_ID != 0) {
    ORWNeighbourTestC$sendMessage();
    }
}
...
#line 445
{
  if (/*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()] && /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()]) {
      if (!/*CtpP.Router*/CtpRoutingEngineP$0$tHasPassed[sim_node()]) {
          ...
          sim_log_debug(296U, "RoutingTimer", "Beacon timer fired at %s\n", sim_time_string());
...
#line 744
{
  ...
  sim_log_debug(229U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
  /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b93452a6c28){
#line 83
  switch (arg_0x2b93452a6c28) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      ORWNeighbourTestC$Timer1$fired();
#line 83
      break;
#line 83
    case 2U:
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b93452a6c28);
#line 83
      break;
#line 83
    }
...
#line 449
{
  sim_log_debug(267U, "LI", "Link estimator init\n");
...
#line 215
  ...
  sim_log_debug(282U, "TreeRoutingCtl", "TreeRouting initialized. (used payload:%d max payload:%d!\n", sizeof /*CtpP.Router*/CtpRoutingEngineP$0$beaconMsg[sim_node()], maxLength);
...
#line 420
{
  ...
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(264U, "LI", "%x ", b[i]);
  sim_log_debug_clear(265U, "LI", "\n");
}
...
#line 371
{
  ...
  if (LinkEstimatorP$NeighborTable[sim_node()][idx].flags & INIT_ENTRY) {
      sim_log_debug(261U, "LI", "Init entry update\n");
  ...
  sim_log_debug(262U, "LI", "updateNeighborEntryIdx: prevseq %d, curseq %d, gap %d\n", LinkEstimatorP$NeighborTable[sim_node()][idx].lastseq, seq, packetGap);
...
#line 218
  ...
  for (i = 0; i < 10; i++) {
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & VALID_ENTRY)) {
          sim_log_debug(253U, "LI", "Invalid so continuing\n");
          continue;
        }
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & MATURE_ENTRY)) {
          sim_log_debug(254U, "LI", "Not mature, so continuing\n");
          continue;
        }
      if (LinkEstimatorP$NeighborTable[sim_node()][i].flags & PINNED_ENTRY) {
          sim_log_debug(255U, "LI", "Pinned entry, so continuing\n");
          continue;
        }
...
#line 517
{
  ...
  sim_log_debug(300U, "TreeRouting", "%s\n", __FUNCTION__);
...
#line 247
      sim_log_debug(165U, "CTPInfo", "received CTP from %d which power is %d\n", __nesc_ntoh_int8(btrpkt->nodeid.nxdata), __nesc_ntoh_int16(btrpkt->power.nxdata));
      sim_log_debug(166U, "CTPInfo", " has %d neighbours:\n", __nesc_ntoh_int8(btrpkt->neighbourNum.nxdata));
      for (i = 0; i < __nesc_ntoh_int8(btrpkt->neighbourNum.nxdata); i++) 
        sim_log_debug(167U, "CTPInfo", " %d with linkQ:%d \n", __nesc_ntoh_uint8(btrpkt->neighbourSet[i].nodeid.nxdata), __nesc_ntoh_uint8(btrpkt->neighbourSet[i].linkquality.nxdata));
      sim_log_debug(168U, "CTPInfo", "\n");
    }
  return msg;
}
...
#line 77
          sim_log_debug_clear(240U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(241U, "QueueC", "] ");
    }
  sim_log_debug_clear(242U, "QueueC", "<- tail\n");
}
...
#line 251
  ...
  sim_log_debug(203U, "Forwarder", "Rexmit timer will fire in %hu ms\n", r);
}
...
#line 529
  sim_log_debug(221U, "Forwarder", "%s to %hu and %hhu\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$AMPacket$destination(msg), error);

  if (error != SUCCESS) {

      sim_log_debug(222U, "Forwarder", "%s: send failed\n", __FUNCTION__);
...
#line 540
    if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$hasState(/*CtpP.Forwarder*/CtpForwardingEngineP$0$ACK_PENDING) && !/*CtpP.Forwarder*/CtpForwardingEngineP$0$PacketAcknowledgements$wasAcked(msg)) {
        ...
        if (-- qe->retries) {
            sim_log_debug(223U, "Forwarder", "%s: not acked, retransmit\n", __FUNCTION__);
...
#line 496
        {
          sim_log_debug(218U, "CtpForwarder", "%s: packet %hu.%hhu for client %hhu dropped.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getOrigin(msg), /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getSequenceNumber(msg), qe->client);
      ...
      if (success) {
          ...
          sim_log_debug(220U, "CtpForwarder", "%s: forwarded packet %hu.%hhu dropped.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getOrigin(msg), /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getSequenceNumber(msg));
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "ORWNeighbourTestC$nx_neighbourSet"))
  {
    *addr = (uintptr_t)&ORWNeighbourTestC$nx_neighbourSet[__nesc_mote];
    *size = sizeof(ORWNeighbourTestC$nx_neighbourSet[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "ORWNeighbourTestC$packet"))
  {
    *addr = (uintptr_t)&ORWNeighbourTestC$packet[__nesc_mote];
    *size = sizeof(ORWNeighbourTestC$packet[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&ORWNeighbourTestC$nx_neighbourSet[__nesc_mote], 0, sizeof ORWNeighbourTestC$nx_neighbourSet[__nesc_mote]);
  memset((void *)&ORWNeighbourTestC$pkt[__nesc_mote], 0, sizeof ORWNeighbourTestC$pkt[__nesc_mote]);
  memset((void *)&ORWNeighbourTestC$packet[__nesc_mote], 0, sizeof ORWNeighbourTestC$packet[__nesc_mote]);
